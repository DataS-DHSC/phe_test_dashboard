...
```{r}
ggplotly(hist1, height = 800, width = 1400)
```

### 31-60

```{r}
ggplotly(hist2, height = 800, width = 1400)
```

### 61-90

```{r}
ggplotly(hist3, height = 800, width = 1400)
```

### 91-120

```{r}
ggplotly(hist4, height = 800, width = 1400)
```

### 121-150

```{r}
ggplotly(hist5, height = 800, width = 1400)
```
