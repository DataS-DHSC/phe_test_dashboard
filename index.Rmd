...
```{r}
ggplotly(hist3, width = 1800, height = 850)
```

### 91-120

```{r}
ggplotly(hist4, width = 1800, height = 850)
```

### 121-150

```{r}
ggplotly(hist5, width = 1800, height = 850)
```
...
### Across Pandemic
```{r}
ggplotly(bar1, width = 1800, height = 850)
```

### Last week 
```{r}
ggplotly(bar2, width = 1800, height = 850)
```
